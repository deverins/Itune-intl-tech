    ...
    <>
      <main className='w-full bg-[#afafd1]'>
        ...
        <div className='w-full flex justify-center my-4'>
          <div className='lg:w-[402px] lg:h-[48px] sm:w-[350px] sm:h-[35px] w-[350px] h-[35px] md:w-[300px] md:h-[35px] text-white rounded-3xl text-center py-1 bg-[#EC1D25] flex justify-center items-center'>
